...
/** Canonical Mark body from docs/the_human_mark/THM.md (without outer fences). */
const HUMAN_MARK = `---
...
/** Full Human Mark in a disclosure panel (About Common Consensus). */
export default function HumanMarkDropdown() {
  return (
    <Accordion
      id="the-human-mark"
      title={
      ...
      subtitle="Full Mark text"
    >
      <pre className="overflow-x-auto whitespace-pre-wrap font-mono text-xs leading-relaxed text-gray-700 dark:text-gray-200 sm:text-sm">
        {HUMAN_MARK}
      </pre>
    </Accordion>
  );
